"""WBC (Whole Body Control) task configuration.
...
from . import mdp
from .mdp.velocity_command import UniformVelocityCommandCfg
...
def make_wbc_env_cfg() -> ManagerBasedRlEnvCfg:
  """Create wbc (Whole Body Control) tracking task configuration."""
  ...
  rewards = {
    "track_linear_velocity": RewardTermCfg(
      ...
      weight=1.5,
      params={"command_name": "twist", "std": math.sqrt(0.25), "include_z": False},
    ),
    "track_linear_velocity_z": RewardTermCfg(
      func=mdp.track_linear_velocity_z,
      weight=1.0,
  ...
  terminations = {
    ...
    "base_height_minimum": TerminationTermCfg(
  ...
  curriculum = {
    ...
    "command_vel": CurriculumTermCfg(
      ...
      params={
        "command_name": "twist",
        "velocity_stages": [
          {"step": 0, "lin_vel_x": (-0.5, 1.0), "lin_vel_y": (-0.5, 0.5), "ang_vel_z": (-1.0, 1.0), "lin_vel_z":(-0.5,0.5)},
