...
class variable_posture:
  ...
  def __init__(self, cfg: RewardTermCfg, env: ManagerBasedRlEnv):
    ...
    _, _, std_height = resolve_matching_names_values(
      data=cfg.params["std_height"],
      list_of_strings=joint_names,
    )
    self.std_height = torch.tensor(std_height, device=env.device, dtype=torch.float32)
  ...
  def __call__(
    ...
    del std_height, std_standing, std_walking, std_running  # Unused.
    ...
    std = (
      ...
      + self.std_height * height_mask.unsqueeze(1)
